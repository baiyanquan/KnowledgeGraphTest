...
//import java.io.File;
//
//public class RDFoxTest {
//    public static void main(String[] args) throws Exception {
//        // 从本体与实例数据文件创建各自的文件对象
//        File ontologyFile = new File(RDFoxTest.class.getResource("/data/finance-onto.owl").toURI());
//        File dataFile = new File(RDFoxTest.class.getResource("/data/finance-data.nt").toURI());
//
//        // 自定义规则
//
